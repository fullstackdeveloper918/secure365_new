...
import SingleProKeyFeature from "./SingleProKeyFeature"
import BeforeAfterProject from './BeforeAfterResults'
import FooterFour from "@/layouts/footers/footer-four";
import { FourthSection } from "../inner-services/ai-services/FourthSection";
// import FooterFour from "@/layouts/footers/footer-four";
import ContactTwo from "@/components/contact/contact-two";
import { config } from "../../../config"
import SellmacGallery from "./SellmacGallery"
...
export const inActionData = {
  title: 'SellMac in Action',
  items: [
    { title: 'SellMac Image 1' },
    { title: 'SellMac Image 2' },
    { title: 'SellMac Image 3' },
    { title: 'SellMac Image 4' },
  ],
};
    ...
    .about-ch-head{
        ...
        h2, h3 {
          ...
          .project-single-banner-sec{
             ...
             justify-content: end;
             padding-bottom: 60px;
             background-image:url('/images/projects/sellamc01banner.png');
        ...
        <div className="container mx-auto">
          <div className="about-proj-wrapper flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="about-single-projectCont w-full md:w-1/2">
              <h1 className="text-3xl font-semibold mb-4 text-white">About SellMac</h1>
      ...
      {/* <section className="py-12 bg-gray-900">
        <h2 className="text-3xl font-semibold text-center text-blue-400 mb-8">{inActionData.title}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto px-4">
          {inActionData.items.map((item, index) => (
            <div key={index} className="bg-gray-800 p-4 rounded">
              <h3 className="text-lg font-medium">{item.title}</h3>
              <div className="h-32 bg-gray-700 mt-2 flex items-center justify-center">Image Placeholder</div>
            </div>
          ))}
        </div>
      </section> */}
