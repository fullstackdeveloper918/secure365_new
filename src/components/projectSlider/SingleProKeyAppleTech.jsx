...
export default function SingleProKeyAppleTech() {
  const KeyFetureProject = [
    {
      image: "/images/about-us.png",
      title: "Full Tech Specs Library",
      description: "Comprehensive hardware details for Apple devices, including discontinued models."
    },
    {
      image: "/images/Ab-Card2.jpg",
      title: "Serial Number Decoder",
      description: "Simple lookup to reveal specs, production dates, and more using serial/model numbers."
    },
    {
      image: "/images/Ab-Card3.jpg",
      title: "Up-to-Date Accuracy",
      description: "Regular updates to ensure customers get the most accurate and transparent spec data."
    },
    {
      image: "/images/Ab-Card4.jpg",
      title: "User-Friendly Interface",
      description: "Simple navigation with search bar and lookup features for smooth user experience."
    }
  ];
  return (
