...
export default function SingleProKeyTechable() {
  const KeyFetureProject = [
    {
      image: "/images/about-us.png",
      title: "Certified Refurbished Devices",
      description: "Every product inspected and backed by Techable Guarantee."
    },
    {
      image: "/images/Ab-Card2.jpg",
      title: "Warranty & Returns",
      description: "30-day money-back guarantee and up to 3-year warranties."
    },
    {
      image: "/images/Ab-Card3.jpg",
      title: "Fast, Free Shipping",
      description: "Efficient logistics ensure quick and free delivery."
    },
    {
      image: "/images/Ab-Card4.jpg",
      title: "Wide Trusted Selection",
      description: "Refurbished Macs, iPads, iPhones, and accessories—all at competitive prices."
    }
  ];
  return (
