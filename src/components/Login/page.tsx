...
const Login: React.FC<LoginProps> = ({ onSuccess }) => {
  ...
  return (
    <section className="login-section bg-[#02050F] pe-5 h-screen">
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="md:w-1/2 image-login-Box h-screen">
          <Image
            ...
            height={893}
            style={{ height: "100%" }}
            className="w-full transform object-cover transition duration-1000 hover:scale-105"
          />
        </div>
        ...
        <div className="md:w-1/2 mt-6 md:mt-0">
          ...
          <p className="text-gray-600 mb-6 login-para-text">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#03afef] text-white py-3 px-4 rounded-md hover:[#0996ca] transition login-btn-main font-medium"
            >
