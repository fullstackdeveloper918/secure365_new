  ...
  return (
    ...
    >
      <div className="absolute inset-0 w-full h-[100vh] z-0">
        <video ref={videoRef} className="w-full h-full object-cover" src="/hero-banner-video.mp4" muted playsInline />
      </div>

      <AnimatePresence>
        {imageVisible && (
          <div className="absolute inset-0  items-center justify-center z-5">
            <motion.img
              src="/hero2.png"
              ...
              <AnimatePresence>
                {showRightText && (
                  <motion.div
                    ...
                    animate={{ scale: 1, opacity: 1 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="space-y-6 main-banner-para-box relative z-10"
                  >
